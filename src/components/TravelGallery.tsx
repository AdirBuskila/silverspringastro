          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent rounded-b-lg">
              ...
              {selectedPhoto.description && (
                <p className="text-white/60 text-sm mt-2">{selectedPhoto.description}</p>
              )}
            </div>
          </div>

          {/* Counter */}
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-white/10 text-white/70 text-sm">
